...
/**
 Returns an instance of `MGLStyle` for the current map style.
 
 The returned object is a proxy for the current map style for customization 
 purposes. It also has a set of convenience methods for creating style URLs of 
 default styles provided by Mapbox.
